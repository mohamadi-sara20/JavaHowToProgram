...
public class Tetrahedron extends ThreeDimensional {
    ...
    @Override
    public double getArea(){return Math.sqrt(3) * Math.pow(getSide(), 2);}

    @Override
    public double getVolume(){return Math.pow(getSide(), 3) / (6 * Math.sqrt(2));}

    @Override
    public String toString(){return String.format("%s: %2f%n", "Side equals", getSide());}
